...
import xyz.nmasnadithya.openweather.ui.main.currentweather.CurrentWeatherContract.RefreshIntent
import xyz.nmasnadithya.openweather.ui.main.currentweather.CurrentWeatherContract.ViewState
...
class CurrentWeatherFragment : MviFragment<CurrentWeatherContract.View,
  ...
  override fun refreshCurrentWeatherIntent(): Observable<RefreshIntent> {
    return swipe_refresh_layout.refreshes()
        ...
        .cast<RefreshIntent>()
        .mergeWith(refreshInitial.doOnNext { Timber.d("Initial weather refresh") })
        .doOnNext { Timber.d("Refreshed weather") }
  }
