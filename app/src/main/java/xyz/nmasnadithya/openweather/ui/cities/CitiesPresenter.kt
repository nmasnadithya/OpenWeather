...
import xyz.nmasnadithya.openweather.ui.cities.CitiesContract.*
import xyz.nmasnadithya.openweather.ui.cities.CitiesContract.PartialStateChange.*
...
class CitiesPresenter(
  ...
  override fun bindIntents() {
    ...
    intent(View::changeSelectedCity)
        ...
        .subscribeBy(
            onNext = { Timber.d("Changing selected city to $it") },
            onError = { Timber.d(it, "Error changing selected city") }
        )
    ...
    subscribeViewState(
        Observable.mergeArray(
            ...
            .doOnNext { Timber.d("Changing ViewState to $it") }
            .observeOn(AndroidSchedulers.mainThread()),
        View::render
    )
  }
