package xyz.nmasnadithya.openweather.ui.setting
...
import xyz.nmasnadithya.openweather.ui.BaseAppCompatActivity
...
import xyz.nmasnadithya.openweather.worker.WorkerUtil.enqueueUpdateCurrentWeatherWorkRequest
import xyz.nmasnadithya.openweather.worker.WorkerUtil.enqueueUpdateDailyWeatherWorkRequest
...
class SettingsActivity : BaseAppCompatActivity(noActionBar = false) {
  ...
  class SettingFragment : PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      findPreference<Preference>("About")!!.setOnPreferenceClickListener {
        Intent(Intent.ACTION_VIEW)
            .apply { data = Uri.parse("https://github.com/nmasnadithya/OpenWeather.git") }
    ...
    override fun onResume() {
      super.onResume()
      /**
       * Sync state between [xyz.nmasnadithya.openweather.CancelNotificationReceiver] and this preference
       */
    ...
    override fun onPreferenceChange(preference: Preference?, newValue: Any?): Boolean {
      ...
      when {
        ...
        key == getString(R.string.key_sound_notification) && newValue is Boolean -> {
          Timber.d("Update notification sound: $newValue")
