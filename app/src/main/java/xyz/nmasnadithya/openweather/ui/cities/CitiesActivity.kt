package xyz.nmasnadithya.openweather.ui.cities
...
import xyz.nmasnadithya.openweather.ui.addcity.AddCityActivity
import xyz.nmasnadithya.openweather.ui.cities.CitiesContract.SearchStringIntent
import xyz.nmasnadithya.openweather.ui.cities.CitiesContract.SearchStringIntent.InitialSearchStringIntent
import xyz.nmasnadithya.openweather.ui.cities.CitiesContract.View
import xyz.nmasnadithya.openweather.utils.snackBar
import xyz.nmasnadithya.openweather.utils.startActivity
import xyz.nmasnadithya.openweather.utils.ui.SwipeController
import xyz.nmasnadithya.openweather.utils.ui.SwipeControllerActions
import xyz.nmasnadithya.openweather.utils.ui.textChanges
...
class CitiesActivity : BaseMviActivity<View, CitiesPresenter>(), View {
  ...
  override fun searchStringIntent(): Observable<SearchStringIntent> {
    return search_view.textChanges()
        ...
        .doOnNext { Timber.d("Intent searchString: $it") }
  }
