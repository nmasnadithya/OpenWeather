...
import xyz.nmasnadithya.openweather.ui.addcity.AddCityContract.View
import xyz.nmasnadithya.openweather.ui.addcity.AddCityContract.ViewState
import xyz.nmasnadithya.openweather.utils.MyUnsafeLazyImpl
import xyz.nmasnadithya.openweather.utils.checkLocationSettingAndGetCurrentLocation
import xyz.nmasnadithya.openweather.utils.exhaustMap
              ...
              cityRepository
                  ...
                  .doOnSuccess { city ->
                    currentWeatherRepository
                        ...
                        .subscribeBy(
                            onSuccess = { Timber.d("Successfully refreshed weather: $it") },
                            onError = { Timber.d(it, "Weather refresh failed") }
                        )
                  }
                  .toObservable()
                  .flatMapIterable {
